...
%>
        ...
        <form action="${pageContext.request.contextPath}/ControllerGetWizytyPracownik" method="post">
            ...
            <div class="form-group" style="margin-bottom:-2px;">
                <select class="form-control" name="pracownik_id" required="" id="pracownik_id" style="margin:0;margin-left:437px;width:265px;margin-bottom:16px;margin-top: -17px;">
                    <%
