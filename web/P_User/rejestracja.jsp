...
<form method="post" action="${pageContext.request.contextPath}/UserRegister" onsubmit="code(this)">
    ...
    <div class="form-group"><input class="form-control" type="text" name="telefon" placeholder="Numer telefonu" maxlength="9" minlength="6" style="width:500px;margin:0;margin-left:145px;"></div>
