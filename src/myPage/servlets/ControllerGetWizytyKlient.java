...
@WebServlet("/ControllerGetWizytyKlient")

public class ControllerGetWizytyKlient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String id_klienta = request.getParameter("klient_id");
        ...
        try {
            wizyty_w_gabinecie.loadWizytyFromToWithClient(data_od, data_do, id_klienta);
            /* Pobierz dane klienta */
            try {
                Klient klient = new Klient(Integer.parseInt(id_klienta));
            ...
            resultMessage = "<section id=\"wizyty_spis_admin\" class=\"bg-light-gray\" style=\"margin:0;background-color:rgba(0,0,0,0.11);color:#ffffff;padding-bottom:20px;padding-top:20px;max-width:1350px;margin-right:auto;margin-left:auto;border-radius:20px;margin-bottom:30px;\">\n" +
                    ...
                    "            <h2 class=\"text-center\" style=\"height:79px;\">Wizyty klienta: " + odczytany_klient.getNazwisko() + " " + odczytany_klient.getImie() + "</h2>\n" +
                    "            <h5 class=\"text-center\" style=\"height:21px;margin-right:50px;margin-left:50px;\">W poniższej sekcji znajdując się wszystkie wizyty znajdujące się w bazie systemu od " + data_od + " do " + data_do + " wybranego klienta.</h5>\n" +
