...
@WebServlet("/ControllerGetWizytyData")

public class ControllerGetWizytyData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            wizyty_w_gabinecie.loadWizytyFroMDatatoData(data_od, data_do);
            ...
            while (!wizyty_w_gabinecie.isEmpty()){
                ...
                resultMessage += "<tr><td>";
                if (!StatusWizyty.getStringVal(odczytana_wizyta.getStatus()).equals("OPLACONE"))
