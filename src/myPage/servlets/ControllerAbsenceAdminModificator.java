...
@WebServlet(name =  "kontroler służący do usuwania zaznaczonych z listy nieobecności", urlPatterns = { "/ControllerAbsenceAdminModificator" })
public class ControllerAbsenceAdminModificator extends HttpServlet {
